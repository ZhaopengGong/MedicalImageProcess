...
a_npy_path = '/home/gongzp/data/3D-FCN-small/groundtruth/0052.npy'
b_npy_path = '/home/gongzp/data/3D-FCN-small/groundtruth/0052.npy'

a_nii = np.load(a_npy_path)
b_nii = np.load(b_npy_path)

# dice_c, conform_c, jaccard_c, precision_c, recall_c = seg_eval_metric(a_nii, b_nii)
dice_c= seg_eval_metric(a_nii, b_nii)
