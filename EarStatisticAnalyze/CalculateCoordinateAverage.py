...
for patient_folder_name in os.listdir(split_ear_coordinate_folder_path):
    if(organ_index <= 11):
        ...
        organ_hf_file_name = ''
        if organ_index == 1:
            ear_organ_average_file_name = 'CG_Average.xlsx'
            organ_hf_file_name = 'CG.xlsx'
        elif organ_index == 2:
            ear_organ_average_file_name = 'ZG_Average.xlsx'
            organ_hf_file_name = 'ZG.xlsx'
        elif organ_index == 3:
            ear_organ_average_file_name = 'DG_Average.xlsx'
            organ_hf_file_name = 'DG.xlsx'
        elif organ_index == 4:
            ear_organ_average_file_name = 'EW1_Average.xlsx'
            organ_hf_file_name = 'EW1.xlsx'
        elif organ_index == 5:
            ear_organ_average_file_name = 'EW2_Average.xlsx'
            organ_hf_file_name = 'EW2.xlsx'
        elif organ_index == 6:
            ear_organ_average_file_name = 'NTD_Average.xlsx'
            organ_hf_file_name = 'NTD.xlsx'
        elif organ_index == 7:
            ear_organ_average_file_name = 'QBGG_Average.xlsx'
            organ_hf_file_name = 'QBGG.xlsx'
        elif organ_index == 8:
            ear_organ_average_file_name = 'HBGG_Average.xlsx'
            organ_hf_file_name = 'HBGG.xlsx'
        elif organ_index == 9:
            ear_organ_average_file_name = 'WBGG_Average.xlsx'
            organ_hf_file_name = 'WBGG.xlsx'
        elif organ_index == 10:
            ear_organ_average_file_name = 'QT_Average.xlsx'
            organ_hf_file_name = 'QT.xlsx'
        elif organ_index == 11:
            ear_organ_average_file_name = 'JJMQW_Average.xlsx'
            organ_hf_file_name = 'JJMQW.xlsx'
        # 创建合并的文件
