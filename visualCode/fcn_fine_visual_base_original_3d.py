...
# Warning Think the circumstance that one digtial divide another digital the resukt is 0
...
seg_fine_result_folder = 'F:/ExperimentData/predict'
original_label_folder = 'F:/ExperimentData/groundtruth'
output_folder = 'F:/ExperimentData/organ_result'
original_dicom_npy_folder = 'F:/ExperimentData/image'
...
for fileName in os.listdir(seg_fine_result_folder):
    ...
    seg_result_file[seg_result_file!=label_number] = 0
